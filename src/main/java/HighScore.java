...
/**
 * Classe gérant l'affichage et la saisie du nom pour le classement des meilleurs scores.
 * 
 * Cette classe affiche l'écran de saisie du nom après la fin d'un jeu, permet à l'utilisateur
 * de saisir son nom à l'aide du joystick, et enregistre le score dans un fichier de classement.
 */
class HighScore{

	/**
	 * Retourne le caractère suivant dans l'ordre alphabétique pour la saisie du nom.
	 * Permet de faire défiler les caractères de A à Z, puis '.' et ' ' pour la saisie du nom.
	 * @param c le caractère actuel sélectionné
	 * @return le caractère suivant dans l'ordre alphabétique
	 */
	...
	/**
	 * Retourne le caractère précédent dans l'ordre alphabétique pour la saisie du nom.
	 * Permet de faire défiler les caractères de A à Z, puis '.' et ' ' pour la saisie du nom.
	 * @param c le caractère actuel sélectionné
	...
	/**
	 * Affiche l'écran de saisie du nom pour le classement des meilleurs scores et enregistre le score.
	 * Affiche les meilleurs scores actuels, permet à l'utilisateur de saisir son nom à l'aide du joystick, et enregistre le score dans le fichier de classement si le score est suffisamment élevé.
	 * @param f la fenêtre de l'interface graphique de la borne d'arcade pour afficher les éléments de l'écran de saisie du nom
	 * @param clavier le gestionnaire du clavier de la borne d'arcade pour détecter les entrées utilisateur
	 * @param t la texture de fond à afficher lors de la saisie du nom
	 * @param s le score obtenu par l'utilisateur à enregistrer
	 * @param fichierHighScore le chemin du fichier de classement des meilleurs scores
	 */
    ...
    /**
     * Enregistre le score dans le fichier de classement des meilleurs scores.
	 * Insère le nouveau score à la position appropriée dans la liste des meilleurs scores, puis écrit la liste mise à jour dans le fichier de classement. Si le score n'est pas suffisamment élevé pour figurer dans le classement, il n'est pas enregistré.
     * @param f la fenêtre de l'interface graphique de la borne d'arcade pour afficher les éléments de l'écran de saisie du nom
     * @param clavier le gestionnaire du clavier de la borne d'arcade pour détecter les entrées utilisateur
     * @param t la texture de fond à afficher lors de la saisie du nom
     * @param s le score obtenu par l'utilisateur à enregistrer
