...
public class Main {
    ...
    private static void launchDeveloppementMode() {
        ...
        boolean autoGenerateDoc = Boolean.parseBoolean(config.getProperty("dev.ai.auto_generate_doc", "true"));
        boolean docEnabled = Boolean.parseBoolean(config.getProperty("dev.doc.enabled", "true"));
        if (autoGenerateDoc && docEnabled) {
