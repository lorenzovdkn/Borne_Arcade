 ...
 * 
 * Cette classe permet de tester visuellement le bon fonctionnement
 * des contrôles de la borne d'arcade (joysticks et boutons).
 * Elle affiche une interface graphique qui change de couleur selon
 * les touches pressées.
 */
class TestClavierBorneArcade{

    /**
     * Méthode principale de test pour le clavier de la borne.
     * 
     * Crée une fenêtre avec des cercles colorés représentant les contrôles
     * de la borne. Les cercles changent de couleur quand les touches
     * correspondantes sont pressées.
     * 
